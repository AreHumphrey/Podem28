    ...
    return (
        <div className="all_frame">
            ...
            <div className="pages_text">
                ...
                <h3>Вы можете обратиться к нам по телефону, по электронной почте или договориться о встрече в нашем
                    офисе. Будем рады помочь вам и ответить на все ваши вопросы.</h3>

                <h2>Телефоны: <br/></h2>
                <h2> 8(4162) 501-933 <br/></h2>
