...
const Ustroystva_predokhranitelnye_dlya_gazosvarki_3 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ЗАТВОР ПРЕДОХРАНИТЕЛЬНЫЙ ЗП-3К-111</h2>
                <p>
...
export default Ustroystva_predokhranitelnye_dlya_gazosvarki_3;