...
import img_3 from "../../../../Components/Img/img_komplektuyushchie_k_reduktoram_i_regulyatoram_manometry_21.jpg"

const Komplektuyushchie_k_reduktoram_i_regulyatoram_manometry_21 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>МАНОМЕТР ГАЗОВЫЙ 16.0 МПА</h2>
...
export default Komplektuyushchie_k_reduktoram_i_regulyatoram_manometry_21;