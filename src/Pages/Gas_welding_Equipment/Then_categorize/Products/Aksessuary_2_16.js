...
import img_3 from "../../../../Components/Img/img_prochie_aksessuary_16.jpg"

const Aksessuary_2_16 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ФИКСАТОР МАГНИТНЫЙ СВАРОЧНЫЙ МФ 101</h2>
                ...
                <p>
                    ...
                    Возможность создать варианты наклона по градусам 30, 45, 60, 90
                    ...
                    Усилие на отрыв 40 кг согласно протоколу испытания.<br/>

                    Выпускается в защитной блистерной упаковке собственного производства по одной штуке.<br/>

                    Все изделия имеют сертификат соответствия по РОСТЕСТ<br/>
...
export default Aksessuary_2_16;