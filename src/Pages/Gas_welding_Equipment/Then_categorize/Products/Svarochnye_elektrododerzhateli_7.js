...
import img_3 from "../../../../Components/Img/img_varochnye_elektrododerzhateli_7.jpg"

const Svarochnye_elektrododerzhateli_7 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ЭЛЕКТРОДОДЕРЖАТЕЛЬ ЭД-50 "САТУРН" (500А)</h2>
                <p>
...
export default Svarochnye_elektrododerzhateli_7;