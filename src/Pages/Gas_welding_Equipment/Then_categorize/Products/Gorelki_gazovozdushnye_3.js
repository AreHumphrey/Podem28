...
const Gorelki_gazovozdushnye_3 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ГВ-850 ФСТАКАНА=50ММ</h2>
                <p>Горелка газовоздушная вентильная (Фстакана=50мм, L= 850мм, 9/6) предназначена преимущественно для
...
export default Gorelki_gazovozdushnye_3;