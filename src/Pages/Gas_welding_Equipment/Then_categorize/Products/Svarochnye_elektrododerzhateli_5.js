...
import img_3 from "../../../../Components/Img/img_varochnye_elektrododerzhateli_5.jpg"

const Svarochnye_elektrododerzhateli_5 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ЭЛЕКТРОДОДЕРЖАТЕЛЬ ЭД-20 "САТУРН" (200А)</h2>
                <p>
...
export default Svarochnye_elektrododerzhateli_5;