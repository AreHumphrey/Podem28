...
import img_3 from "../../../../Components/Img/img_gorelki_gazovozdushnye_5.jpg"

const Gorelki_gazovozdushnye_5 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ГВ-850-Р ФСТАКАНА=60ММ</h2>
                <p>Горелка газовоздушная рычажная (Фстакана=60мм, L= 850мм, 9/6) предназначена преимущественно для
...
export default Gorelki_gazovozdushnye_5;