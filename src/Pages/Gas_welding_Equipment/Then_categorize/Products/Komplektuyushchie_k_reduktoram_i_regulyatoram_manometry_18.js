...
import img_3 from "../../../../Components/Img/img_komplektuyushchie_k_reduktoram_i_regulyatoram_manometry_18.jpg"

const Komplektuyushchie_k_reduktoram_i_regulyatoram_manometry_18 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>МАНОМЕТР АЦЕТИЛЕНОВЫЙ 4.0 МПА</h2>
                <p>Манометры ацетиленовые сварочные (общетехнические) тип ТМ предназначены для измерения давления в
                    пределах от 0 до 4,0 МПа в газообразных неагрессивных средах. Манометры ацетиленовые сварочные
...
export default Komplektuyushchie_k_reduktoram_i_regulyatoram_manometry_18;