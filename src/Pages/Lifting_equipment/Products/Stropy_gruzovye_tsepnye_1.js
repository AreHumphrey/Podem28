...
const Stropy_gruzovye_tsepnye_1 = () => {
    return (
        <div className="all_frame">
            ...
            <div className="pages_text">
                ...
                <p>Цепные стропы, собранные из комплектующих 8кл. прочности произведенными немецкой компании D.H.A. –это
                    ...
                    Сборк а цепных строп происходит без применения сварки, простым соединением элементов.
...
export default Stropy_gruzovye_tsepnye_1;