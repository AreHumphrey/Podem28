...
import img_3 from "../../../Components/Img/img_6_mini-tali-elektricheskie.png"

const Mini_tali_elektricheskie_6 = () => {
    return (
        <div className="all_frame">
            <ButtonAppBar/>
            <div className="pages_text">
                <h2>ТИП МЕН, СТАЦИОНАРНАЯ</h2>
                <p>Стационарная модель МЕН используется, когда перемещение тали по балке не требуется. Устанавливается
...
export default Mini_tali_elektricheskie_6;